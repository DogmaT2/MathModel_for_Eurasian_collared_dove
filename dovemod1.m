...
% Dispersal-Growth
% Each Nt curve is plotted after growth 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
% Convert T(z) to T(x) where z is the latitude w.r.t southern most point
% and x is the corresponding distance from the southern most point in 100Km.    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sigma               = 18.6;
pp1                 = 16.07;
q1                  = 13.84;
...
%end % while loop
  ...
  Npl1 = temp2; % update the population
  Np1_plot1  = Npl1;
